...
public class Test {
    public static void main(String[] args){
        ...
        Casilla trans4 = new Casilla(   "E.F.F.C.C Santiago", "transporte", 35, 300000);
        ...
        String texto;
        texto = "";
        for (Casilla casillas : ladoNorte.getCasillas()){
            texto += "|" + casillas.getNombre() + "|";
        }
        texto += "\n";

        for (Casilla casillas : ladoSur.getCasillas()){
            texto += "|" + casillas.getNombre() + "|";
        }
